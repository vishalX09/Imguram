...
public class Image_ProcessingJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<Image.Processing>() {
  ...
  public override fun toString(): String = buildString(38) {
      append("GeneratedJsonAdapter(").append("Image.Processing").append(')') }

  public override fun fromJson(reader: JsonReader): Image.Processing {
  ...
  public override fun toJson(writer: JsonWriter, value_: Image.Processing?): Unit {
    if (value_ == null) {
