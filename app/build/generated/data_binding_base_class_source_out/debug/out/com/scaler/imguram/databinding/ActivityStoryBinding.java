...
public final class ActivityStoryBinding implements ViewBinding {
  ...
  private ActivityStoryBinding(@NonNull FrameLayout rootView, @NonNull View progressView,
      @NonNull ViewPager2 storyViewPager) {
  ...
  public static ActivityStoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStoryBinding((FrameLayout) rootView, progressView, storyViewPager);
    }
